...
public class TCurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("T Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the T Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"ACCT", "ALDAC", "HSSA&", "AHE", "AHEA", "AHEL", "AHEM", "AHEP",
                "BIOL", "BIOL&", "BUS", "BUS&", "CHIN", "CHIN&", "DUTEC", "EXPRL", "HLTH", "HPM",
                "HCI", "DMA", "HCML", "HD", "IT", "ISIT", "JAPN", "JAPN&", "MKTG", "DOSM", "NUTR",
                "NUTR&", "NDT", "NMTEC", "NURS", "RECED", "PE", "POLS", "POLS&", "PSYC", "PSYC&",
                "RAIT", "RADON", "RATEC", "SOC", "SOC&"};
