...
public class LCurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("L Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the L Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"CMST", "CMST&", "CS", "ENGR", "ENGR&", "ENGL", "ENGL&", "HD", "INDES",
        "MKTG", "MATH", "MATH&", "POLS", "POLS&", "SOC", "SOC&"};
