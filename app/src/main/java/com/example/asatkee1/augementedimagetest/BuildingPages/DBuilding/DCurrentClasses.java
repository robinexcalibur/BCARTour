...
public class DCurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("D Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the D Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"ANTH", "ANTH&", "CJ", "CJ&", "CES", "DMA", "FRCH", "FRCH&", "GEOG", "GEOG&",
                                   "HIST", "HIST&", "HD", "INTST", "JAPN", "JAPN&", "MATH", "MATH&", "PHIL",
                                   "PHIL&", "POLS", "POLS&", "PSYC", "PSYC&"};
