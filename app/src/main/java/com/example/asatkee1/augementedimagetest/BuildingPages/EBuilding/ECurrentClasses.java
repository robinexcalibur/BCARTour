...
public class ECurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("E Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the E Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"CMST", "CMST&", "DRMA", "DRMA&", "MUSC", "MUSC&" };
