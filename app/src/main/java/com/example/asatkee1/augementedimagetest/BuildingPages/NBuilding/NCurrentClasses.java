...
public class NCurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("N Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the N Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"BUSIT", "CHIN", "CHIN&", "DMA", "DRMA", "DRMA&", "IT", "ISIT", "JAPN",
                                   "JAPN&", "NSCOM", "RECED", "PE", "PROG", "ROBAN", "SPAN", "SPAN&"};
