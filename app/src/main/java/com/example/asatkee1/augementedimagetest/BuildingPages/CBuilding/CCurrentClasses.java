...
public class CCurrentClasses extends AppActivityBuilderMethods {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("C Building Classes");
        ...
        // --- topLayout ---
        subTitleBuilder("Current Classes in the C Building", topLayout);
        ...
        // --- Async task ---
        final String[] deptlist = {"ACCT&", "ART", "BA", "BUS", "BUS&", "CMST", "CMST&", "ENGL",
                                   "ENGL&", "INDE", "INTST", "ITAL", "MKTG", "MATH", "MATH&",
                                   "RECED", "PE", "SOC", "SOC&"};
